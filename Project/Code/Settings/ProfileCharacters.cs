...
namespace Launcher.Code.Settings
{
    class ProfileCharacters
    {
        ...
        dynamic profile_content = JsonConvert.DeserializeObject(data);
            public ProfileCharacters(string filepath, string filename = "character.json") // last parameter is for object oriented return
            {
